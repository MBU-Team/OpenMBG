...
# ADD CPP /nologo /MT /GR /O2 /I "../lib/directx8" /I "../lib/vorbis/include" /I "../lib/zlib" /I "../lib/lungif" /I "../lib/lpng" /I "../lib/ljpeg" /I "../lib/openal/win32" /I "../engine" /YX /FD /c /Tp
...
# ADD LINK32 COMCTL32.LIB COMDLG32.LIB USER32.LIB ADVAPI32.LIB GDI32.LIB WINMM.LIB WSOCK32.LIB ljpeg.lib lpng.lib lungif.lib zlib.lib vfw32.lib ../lib/vorbis/win32/ogg_static.lib ../lib/vorbis/win32/vorbis_static_mt.lib /nologo /subsystem:console /incremental:yes /machine:I386 /nodefaultlib:"LIBC" /out:"../example/torqueDemo.exe" /libpath:"../lib/out.VC6.RELEASE"
...
# ADD CPP /nologo /MT /Gm /GR /ZI /Od /I "../lib/directx8" /I "../lib/vorbis/include" /I "../lib/zlib" /I "../lib/lungif" /I "../lib/lpng" /I "../lib/ljpeg" /I "../lib/openal/win32" /I "../engine" /D "TORQUE_DEBUG" /FR /YX /FD /GZ /c /Tp
...
SOURCE=..\engine\gui\guiBitmapBorderCtrl.cc
# End Source File
# Begin Source File
...
SOURCE=..\engine\gui\guiFadeinBitmapCtrl.cc
# End Source File
# Begin Source File
