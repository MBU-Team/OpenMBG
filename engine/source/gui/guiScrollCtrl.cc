...
{
   Point2I borderExtent(mProfile->mBorderThickness, mProfile->mBorderThickness);
...
void GuiScrollCtrl::calcScrollRects(void)
{
   if (mHasHScrollBar)
   {
      mLeftArrowRect.set(mProfile->mBorderThickness,
                        mBounds.extent.y - mProfile->mBorderThickness - mScrollBarThickness - 1,
                        mScrollBarArrowBtnLength,
                        mScrollBarThickness);

      mRightArrowRect.set(mBounds.extent.x - mProfile->mBorderThickness - (mHasVScrollBar ? mScrollBarThickness : 0) - mScrollBarArrowBtnLength,
                        mBounds.extent.y - mProfile->mBorderThickness - mScrollBarThickness - 1,
                        mScrollBarArrowBtnLength,
                        mScrollBarThickness);
   ...
   if (mHasVScrollBar)
   {
      mUpArrowRect.set(mBounds.extent.x - mProfile->mBorderThickness - mScrollBarThickness,
                        mProfile->mBorderThickness,
                        mScrollBarThickness,
                        mScrollBarArrowBtnLength);
      mDownArrowRect.set(mBounds.extent.x - mProfile->mBorderThickness - mScrollBarThickness,
                        mBounds.extent.y - mProfile->mBorderThickness - mScrollBarArrowBtnLength - (mHasHScrollBar ? ( mScrollBarThickness + 1 ) : 0),
                        mScrollBarThickness,
                        mScrollBarArrowBtnLength);
