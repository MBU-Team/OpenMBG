...
#ifndef GL_VERSION_1_2 // !!!!!!TBD - what to do if someone builds under GL < 1.2 ???
#warning "NOTE: You are building against an old OpenGL SDK!  It may not be supported properly!"
#endif

// earlier 1.2 releases didn't have these defined.
#ifndef UNSIGNED_SHORT_5_6_5
#define UNSIGNED_SHORT_5_6_5                      0x8363
#endif
#ifndef UNSIGNED_SHORT_5_6_5_REV
...
{
#if !defined(TORQUE_OS_MAC_OSX) && ENABLE_NPATCH
