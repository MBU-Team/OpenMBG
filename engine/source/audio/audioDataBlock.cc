...
{
   Con::registerType("AudioEnvironmentPtr", TypeAudioEnvironmentPtr, sizeof(AudioEnvironment*),
...
void AudioSampleEnvironment::consoleInit()
{
   ...
   Con::registerType("AudioSampleEnvironmentPtr", TypeAudioSampleEnvironmentPtr,
...
{
   Con::registerType("AudioDescriptionPtr", TypeAudioDescriptionPtr, sizeof(AudioDescription*),
...
{
   Con::registerType("AudioProfilePtr", TypeAudioProfilePtr, sizeof(AudioProfile*),
