...
void AudioEmitter::initPersistFields()
{
   ...
   addGroup("Profile");	// MM: Added Group Header.
   ...
   endGroup("Profile");	// MM: Added Group Footer.
   ...
   addGroup("Sound");	// MM: Added Group Header.
   ...
   endGroup("Sound");	// MM: Added Group Footer.

   addGroup("Looping");	// MM: Added Group Header.
   ...
   endGroup("Looping");	// MM: Added Group Footer.

   addGroup("Sound Cone");	// MM: Added Group Header.
   ...
   endGroup("Sound Cone");	// MM: Added Group Footer.
