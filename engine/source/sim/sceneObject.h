...
class SceneObject : public NetObject, public Container::Link
{
  ...
  public:
   ...
   //enum TraverseColor {  // I am replacing this with something that makes sense -KB
   //   White = 0,
   //   Grey  = 1,
   //   Black = 2
   //};
...
public:
  ...
  private:
   //TraverseColor mTraverseColor; // Changed to something that makes sense - KillerBun
...
// Changed to something that makes sense -KB
