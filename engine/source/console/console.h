...
struct ConsoleLogEntry
{
   ...
   /// succesfully", or nearly anything else you might imagine.
   ///
...
namespace Con
{
   ...
   enum Constants {
      ...
      MaxDataTypes = 256    ///< Maximum number of registereed data types.
   };

   /// @name Control Functions
   ///
   /// The console must be initialized and shutdown appropriately during the
   /// lifetime of the app. These functions are used to manage this behaviour.
   ///
   ...
   ///       the console. It calls getLog() to get the on-screen
