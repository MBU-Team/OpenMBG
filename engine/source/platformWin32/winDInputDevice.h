...
{
   public:
      static LPDIRECTINPUT8A smDInputInterface;
   ...
   protected:
      ...
      //--------------------------------------
      LPDIRECTINPUTDEVICE8A mDevice;  
      DIDEVICEINSTANCEA     mDeviceInstance;
      ...
      //--------------------------------------
      DIDEVICEOBJECTINSTANCEA* mObjInstance;
      ...
      static BOOL CALLBACK EnumObjectsProc( const DIDEVICEOBJECTINSTANCEA *doi, LPVOID pvRef );
   ...
   public:
      DInputDevice( const DIDEVICEINSTANCEA* deviceInst );
      ~DInputDevice();
