...
// Static class data:
LPDIRECTINPUT8A DInputDevice::smDInputInterface;
...
//------------------------------------------------------------------------------
DInputDevice::DInputDevice( const DIDEVICEINSTANCEA* dii )
{
   mDeviceInstance   = *dii;
   mDevice           = NULL;
   mAcquired         = false;
...
//------------------------------------------------------------------------------
BOOL CALLBACK DInputDevice::EnumObjectsProc( const DIDEVICEOBJECTINSTANCEA* doi, LPVOID pvRef )
{   
   ...
   DIDEVICEOBJECTINSTANCEA* objInstance = &diDevice->mObjInstance[diDevice->mObjEnumCount];
...
bool DInputDevice::enumerateObjects()
{
   ...
   mObjInstance   = new DIDEVICEOBJECTINSTANCEA[mObjCount];
...
{
   DIDEVICEOBJECTINSTANCEA *inst = mObjInstance;
...
{
   DIDEVICEOBJECTINSTANCEA &objInstance = mObjInstance[offset];
