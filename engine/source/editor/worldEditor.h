...
class WorldEditor : public EditTSCtrl
{
   typedef EditTSCtrl Parent;
	...
	public: 
   	...
   	// XA: Replaced the friend methods with real class methods.
	// Console definitions to clean up the call of ConsoleMethods
   ...
   private:
	...
	public:      
		// XA: Made these public for consoleMethods
